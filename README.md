...
- **组图配套文案**：组图生成的同时自动写好发布文案——小红书出中文标题（带 emoji 钩子）+ 种草正文 + 话题标签，Instagram 出英文 hook + caption + hashtags；文案跟随组图卡片展示，可一键复制全部/仅标题，不满意可重新生成。画布工作台内置完整组图入口（预设/平台画幅/张数/渠道独立选择）
